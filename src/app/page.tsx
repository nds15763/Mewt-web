...
const mockPosts = [
  ...
  {
    title: "社区故事：跨越 1000 公里的骑行，寻找失落的古村落",
    excerpt: "来自上海的驴友通过 Mewt 社区的路线建议，成功完成了从成都到拉萨的骑行挑战...",
    date: "2026-02-20",
    category: "旅行故事",
    slug: "community-story-cycling"
  }
];
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
                社区动态与<span className="text-brand-purple italic">旅行指南</span>
              </h2>
            </div>
            <Link 
              href="/blog" 
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-br from-brand-purple-dark to-brand-purple p-12 md:p-20 rounded-5xl text-center text-white relative overflow-hidden shadow-2xl shadow-brand-purple/30">
            ...
            <p className="text-xl md:text-2xl opacity-90 mb-12 max-w-2xl mx-auto relative z-10 leading-relaxed font-medium">
              准备好记录您的下一次冒险了吗？
              <br className="hidden md:block" />立即下载 Mewt，开启您的全球旅行足迹。
            </p>
